...
if (SONAR_Distance > takeoff_min_ground_altitude) {
...
if (Takeoff_Armed) {
    ...
    Engine_Speed = Engine_Speed_Max ; //We put the engine to the MAX speed


//Stabilise ROLL


//Stabilize PITCH with takeoff_angle

//Stabilise YAW with takeoff_angle
YAW_takeoff_angle
...
else if (GPS_current_altitude < (GPS_takeoff_altitude + takeoff_security)) {
...
Mode_Secure(); //turn off engine and try to stabilize
